...
export class MuseumRepository implements IMuseumRepository {
  async getMuseums(): Promise<MuseumModel.Museum[]> {
    return [
      {
        id: "1",
      ...
      },
      {
        ...
        is_remarkable_for:
          "Its iconic structure and breathtaking views of Paris.",
        interest:
          "Visitors interested in iconic landmarks and panoramic views.",
        address: {
          line1: "Champ de Mars",
      ...
      },
      {
        ...
        is_remarkable_for:
          "Its symbolic representation of freedom and democracy.",
